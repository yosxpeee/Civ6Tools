...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/UI/Icons/Buildings/BuildingsTemplate32.psd"/>
	<m_SourceObjectName text="loose_layers_only"/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2330243345</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="BuildingsTemplate32.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="BuildingsTemplate32"/>
	<m_Description text=""/>
	<m_Tags>
